	...
	Query.field = function(params) {
		...
		if(origin == 'prodes'){
			return [
				...
				{
					id: 'prodes',
					sql: "SELECT (ST_EXTENT((ST_BUFFER(geom::GEOGRAPHY,1000))::GEOMETRY)) as polygon FROM prodes_cerrado WHERE gid = ${gid}"
			...
			return [
				...
				{
					id: 'deter',
					sql: "SELECT ST_EXTENT((ST_BUFFER(geom::GEOGRAPHY,1000))::GEOMETRY) as polygon FROM deter_cerrado WHERE gid = ${gid}"
				}
			]
		}
	}
