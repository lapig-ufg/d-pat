...
module.exports = function(app) {
    ...
    Controller.timeseries = function(request, response) {
        ...
        var indicatorYear = Number(request.param('year', 2021));
    ...
    Controller.states = function(request, response) {
        ...
        var year = Number(request.param('year', 2021));
    ...
    Controller.cities = function(request, response) {
        ...
        var result = {
            ...
            rows_labels: languageJson["charts_box_cities"]["rows_labels"][language],
            series: queryResult
        }
    ...
    Controller.illegal = function(request, response) {
        ...
        let index = 1;
        for (var i = 0; i < queryResultAPP.length; i++) {
        ...
        index = 1;
        for (var i = 0; i < queryResultRL.length; i++) {
    ...
    Controller.app = function(request, response) {
        var language = request.param('lang')

        var queryResultAPP = request.queryResult;
    ...
    Controller.rl = function(request, response) {
        var language = request.param('lang')

        var queryResultRL = request.queryResult;
